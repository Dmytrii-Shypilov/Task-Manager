export const projects = [
    {   
        ...
        materials: [{name: "project brochure", link: 'link path'}, {name: "project second brochure ", link: 'link path'}] ,
        contributors: [{id: '129945', name: "Jim Parsons", role: 'assistant'},{id: '123445', name: "Anna Barrow", role: 'assistant'}, {id:"334345",name: "James Milner", role: 'admin'}],
        categories: ['Content', 'Instagram Stories', 'Instagram Reels'],
        tasks: [{category: "Content", tasks: [{
            id: '388383',
